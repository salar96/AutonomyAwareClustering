function dYl = grad_fitnet(net, X, J, Y, Y_l, l)
% For a fitnet/feedforwardnet 'net' with scalar output, return:
%   y(i)   = net([X(i,:), onehot(J(i)), Y(:)'])
%   dYl(i,:) = ∂y(i)/∂Y(l,:)  (1xN), ONLY wrt the l-th centroid row
