function [X,K,T_P,M,N] = data_RLClustering_ModelFree(idx)
    if idx == 1
    ...
    elseif idx == 4
        ...
        %C11 = [-2 -3]; C21 = [4 -1]; C31 = [5 3]; C41 = [-4 3];
        rng('default');
    ...
    elseif idx == 7
        ...
        X = [data.AvgWatchTimeHrs data.GenreDiversity data.ActionPct...
            data.DramaPct data.ComedyPct data.TrendingContentPct data.BingeFrequency data.LateNightViewingPct];
        ...
        elseif idx == 8
            rng('default');
            data = readtable('streaming_users_from_movielens.csv');
            X = [data.WatchTime data.GenresWatched data.TrendingContentPct...
